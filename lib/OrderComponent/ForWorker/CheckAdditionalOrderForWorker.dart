...
class CheckAdditionalOrderForWorker extends StatefulWidget {
  ...
  CheckAdditionalOrderForWorker({Key key, this.orderData, this.orderList, this.subtotal, this.wholeMenu, this.onCallbackOrderList, this.restoId, this.count, this.createdBy, this.takeaway}) : super(key: key);
  @override
  CheckAdditionalOrderForWorkerState createState() => CheckAdditionalOrderForWorkerState();
}

class CheckAdditionalOrderForWorkerState extends State<CheckAdditionalOrderForWorker> {
  List<int> tempTotal =[];
  int subtotal = 0; 
  List finalStatus; 
  String invoiceCode;
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    child: Text('Submit Order', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25),),
                  ),
                ),
              ],
            ),
  ...
  Future<void> _updateData() async {
    ...
    addOrderRef.get().then((value) async {
      ...
      var newObj = {
        ...
        'createdBy': widget.createdBy.toUpperCase(),
        'verified': 'no',
      };
      debugPrint('>>>$newObj');
      data.add(newObj);
